...
describe('controller', function () {
	...
	describe('routing', function () {
		...
		it('should show completed entries', function () {
			...
			//model read called with completed true and function
	...
	describe('toggle all', function () {
		it('should toggle all todos to completed', function () {
			// TODO: write test
			var todo = [{ id: 34, title: 'my todo', completed: false }, { id: 35, title: 'new todo', completed: false }]
			setUpModel(todo);
			...
			expect(model.update).toHaveBeenCalledWith(35, { completed: true }, jasmine.any(Function));
		});
